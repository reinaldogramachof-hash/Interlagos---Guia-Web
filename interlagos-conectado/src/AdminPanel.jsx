...
import ApprovalsTab  from './features/admin/tabs/ApprovalsTab';
import MerchantsTab  from './features/admin/tabs/MerchantsTab';
import NewsTab       from './features/admin/tabs/NewsTab';
import CampaignsTab  from './features/admin/tabs/CampaignsTab';
import UsersTab      from './features/admin/tabs/UsersTab';
import TicketsTab    from './features/admin/tabs/TicketsTab';
import AuditTab      from './features/admin/tabs/AuditTab';
import DatabaseTab   from './features/admin/tabs/DatabaseTab';
import EscalationDialog from './features/admin/EscalationDialog';
